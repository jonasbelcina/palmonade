...
function palmonade_scripts() {
	...
	wp_register_style('palmonade-bootstrap', get_template_directory_uri().'/assets/css/bootstrap' . $suffix . '.css', array(), '3.3.6' );
	...
	wp_enqueue_style('palmonade-style');
...
function shortenText($text, $num) { // Function name ShortenText
...
// remove rating, price, and Add to cart on Shop listings
remove_action('woocommerce_after_shop_loop_item_title', 'woocommerce_template_loop_rating', 5);
remove_action('woocommerce_after_shop_loop_item_title', 'woocommerce_template_loop_price', 10);
remove_action('woocommerce_after_shop_loop_item', 'woocommerce_template_loop_add_to_cart', 10);

// remove rating, price, excerpt, add to cart, meta, and sharing on Kitchen details page
remove_action('woocommerce_single_product_summary', 'woocommerce_template_single_rating', 10);
remove_action('woocommerce_single_product_summary', 'woocommerce_template_single_price', 10);
remove_action('woocommerce_single_product_summary', 'woocommerce_template_single_excerpt', 20);
remove_action('woocommerce_single_product_summary', 'woocommerce_template_single_add_to_cart', 30);
remove_action('woocommerce_single_product_summary', 'woocommerce_template_single_meta', 40);
remove_action('woocommerce_single_product_summary', 'woocommerce_template_single_rating', 50);

// remove data tabs and upsell display on Kitchen details page
remove_action('woocommerce_after_single_product_summary', 'woocommerce_output_product_data_tabs', 10);
remove_action('woocommerce_after_single_product_summary', 'woocommerce_upsell_display', 15);

// function custom_woo_archive_query( $query ) {
